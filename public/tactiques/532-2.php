<?php
    ...
    if($match->getLigne3E2()->unwrap()[1]!=null){
        $pdf->Cell( 7, 7, $pdf->Image("../public/images/".$match->getLigne3E2()->unwrap()[1]->getPhoto(), 440, 480, 20), 0, 0, 'L', false );
    }else{
    ...
    if($match->getLigne2E2()->unwrap()[1]!=null){
        $pdf->Cell( 7, 7, $pdf->Image("../public/images/".$match->getLigne2E2()->unwrap()[1]->getPhoto(), 415, 520, 20), 0, 0, 'L', false );
    }else{
        $pdf->Cell( 7, 7, $pdf->Image($slot, 415, 520, 20), 0, 0, 'L', false );
    }
    ...
    if($match->getLigne1E2()->unwrap()[0]!=null){
        $pdf->Cell( 7, 7, $pdf->Image("../public/images/".$match->getLigne1E2()->unwrap()[0]->getPhoto(), 360, 585, 20), 0, 0, 'L', false );
    }else{
        $pdf->Cell( 7, 7, $pdf->Image($slot, 360, 585, 20), 0, 0, 'L', false );
    }
    if($match->getLigne1E2()->unwrap()[1]!=null){
        $pdf->Cell( 7, 7, $pdf->Image("../public/images/".$match->getLigne1E2()->unwrap()[1]->getPhoto(), 385, 595, 20), 0, 0, 'L', false );
    }else{
        $pdf->Cell( 7, 7, $pdf->Image($slot, 385, 595, 20), 0, 0, 'L', false );
    }
    if($match->getLigne1E2()->unwrap()[2]!=null){
        $pdf->Cell( 7, 7, $pdf->Image("../public/images/".$match->getLigne1E2()->unwrap()[2]->getPhoto(), 415, 615, 20), 0, 0, 'L', false );
    }else{
